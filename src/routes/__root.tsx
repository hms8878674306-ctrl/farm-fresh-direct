...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Buy fresh produce directly from local farmers. No middlemen. Same-day delivery, COD available." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "KrishiDirect — Freshness Direct From Farm" },
      { name: "twitter:description", content: "Buy fresh produce directly from local farmers. No middlemen. Same-day delivery, COD available." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/6de43b92-72c1-4bb6-a2d8-fb5c72a6473c" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/6de43b92-72c1-4bb6-a2d8-fb5c72a6473c" },
